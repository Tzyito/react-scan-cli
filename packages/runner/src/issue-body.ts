...
export function buildOverflowStub(
  report: PageReport,
  projectName: string,
...
> ⚠️ **Report too large for inline display.**
> Full report (including screenshot and all sections) has been saved to the repository:
> [View full report](${reportFileUrl})
